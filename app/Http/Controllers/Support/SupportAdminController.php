...
class SupportAdminController extends Controller
{
    ...
    public function update(Request $request){
     ...
     public function show($userId){
        $id = $userId;
        if(Auth::user()->role === 'Support Admin'){
    ...
    public function filter(Request $request){
        ...
        if($request->ward=="" && $request->user=="" && $request->from==''){
             $data['users_search'] = DB::table('users')
                        ->where('role', 'Support Admin')->get();
            $data['users'] = DB::table('users')
                        ->where('role', 'Support Admin')->get();
            $data['wards'] = DB::table('wards')->orderBy('ward_no', 'asc')->get();
    ...
    public function supportAdminGenView($date, $user_id){
        $query = "select * from general_members where added_by='".$user_id."' and date(created_at)='".$date."' order bt created_at";
