        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" name="owner_name" class="form-control owner_name" value="<?php echo $get_data->owner_name; ?>" readonly="">
            </div>
          </div>
      ...
      <?php endif; ?>
         ...
         <div class="col-sm-6">
            <div class="form-group">
                ...
                <?php else: ?>
                    <input type="text" name="total_due_amount" id="total_due_amount" class="form-control" value="<?php echo $due_cost * $get_data->trade_total; ?>" readonly="">
                <?php endif; ?>
             </div> 
         </div>
