        ...
        <section class="content  card card-primary">
            <div class="container-fluid">
                <div class="row mb-2" style="margin-top: 20px">
                    <div class="col-sm-6">
                        <h4> বসতবাড়ী হোল্ডিং নিবন্ধন করুন</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">হোম</a></li>
                            <li class="breadcrumb-item active"> বসতবাড়ী হোল্ডিং নিবন্ধন করুন</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="website-form form-group">
                            ...
                            <form role="form" action="{{ route('store.general_member') }}" method="post"
                                ...
                                <div class="row ">
                                    <div class="col-sm-4" id="name">
                                        ...
                                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control" placeholder="নাম" autocomplete="off">
                                        @error('name')
                                    ...
                                    <div class="col-sm-4" id="father_name">
                                        ...
                                        <input type="text" name="father_name" class="form-control gurdian_status"
                                            id="father_name" value="{{ old('father_name') }}" autocomplete="off" placeholder="পিতার নাম">
                                            @error('father_name')
                                                <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                                </small>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" name="mother_name" value="" class="form-control"
                                            id="mother_name" value="{{ old('mother_name') }}" placeholder="মায়ের নাম" autocomplete="off">
                                            @error('mother_name')
                                               <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                               </small>
                                    ...
                                    <div class="col-sm-3">
                                        <label for="nid_birth" class="col-form-label">
                                            ...
                                            <span style="color: red">*</span></label>
                                        <input type="text" name="nid" value="" class="form-control birth_nid" id="nid_birth" value="{{ old('nid') }}"  autocomplete="off" placeholder="এনআইডি নম্বর">
                                    </div>

                                    <div class="col-sm-3">
                                        <label for="mobile" class="col-form-label">মোবাইল<span
                                                style="color: red">*</span></label>
                                        <input type="text" name="mobile" value="{{ old('mobile') }}"  class="form-control" id="mobile" placeholder="মোবাইল" autocomplete="off"  >
                                            @error('mobile')
                                                <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                               </small>
                                    ...
                                    <div class="col-sm-3" style="margin-top: 5px;">
                                        <div class="form-group">
                                            ...
                                            <input name="member_male" type="number" value="{{ old('member_male') }}"  class="form-control"
                                    ...
                                    <div class="col-sm-3" style="margin-top: 5px;">
                                        <div class="form-group">
                                            ...
                                            <input name="member_female" value="{{ old('member_female') }}"  type="number" class="form-control"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <label for="holding_no" class="col-form-label">হোল্ডিং নং <span
                                                        style="color: red">*</span> </label>
                                                <input type="text" name="holding_no" value="" class="form-control" value="{{ old('holding_no') }}"  id="holding_no" placeholder="হোল্ডিং নং" autocomplete="off"  >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <label for="number_room" class="col-form-label">রুম পরিমাণ<span
                                                        style="color: red">*</span></label>
                                                <input type="text" name="number_room" class="form-control" value="{{ old('number_room') }}" 
                                                    id="number_room" placeholder="রুম পরিমাণ" autocomplete="off" >
                                                    @error('number_room')
                                                        <small class="text-danger">
                                                            <strong>{{ $message }}</strong>
                                                        </small>
                                            ...
                                            <div class="col-sm-4">
                                                <label for="house_year_value" class="col-form-label">বাড়ির বার্ষিক
                                                    মান</label>
                                                <input type="number" name="house_year_value" readonly
                                                    class="form-control house_year_value2" id="house_annual_val2"
                                                    placeholder="বাড়ির বার্ষিক মান" autocomplete="off"   value="0">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="number" name="yearly_vat" class="form-control yearly_vat" value="0" readonly="" >
                                                    @error('yearly_vat')
                                                        <small class="text-danger">
                                                            <strong>{{ $message }}</strong>
                                                        </small>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label for="service_charge" class="col-form-label">নিবন্ধন চার্জ<span
                                                            style="color: red">*</span></label>
                                                    <input type="text" name="service_charge" value="{{ old('service_charge') }}" 
                                                        class="form-control" id="service_charge"
