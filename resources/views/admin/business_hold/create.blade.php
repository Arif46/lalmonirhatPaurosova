    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row mb-2" style="margin-top: 20px">
            <div class="col-sm-6">
                <h4>ব্যবসা প্রতিষ্টান নিবন্ধন</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">হোম</a></li>
                    <li class="breadcrumb-item active">ব্যবসা প্রতিষ্টান নিবন্ধন</li>
                </ol>
            </div>
        </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary website-form">
                        <div class="card-header">
                            <h3 class="card-title">ব্যবসা প্রতিষ্টান নিবন্ধন</h3>
                        </div>
                        <form role="form" action="{{route('store.business_holding')}}" method="post" enctype="multipart/form-data" name="form">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" name="owner_name" value="{{ old('owner_name') }}" class="form-control" id="owner_name" placeholder="নাম">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <span style="color: red">*</span>
                                            <input type="text" class="form-control" name="mother_name" placeholder="মাতার নাম" value="{{ old('mother_name') }}" >
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="nid" value="{{ old('nid') }}" class="form-control birth_nid" id="nid_birth" autocomplete="off" placeholder="এনআইডি নম্বর">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" name="mobile" value="{{ old('mobile') }}" class="form-control mobile" id="mobile" placeholder="মোবাইল">
                                            @error('mobile')
                                            <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                               </small>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select name="ward_id" id="ward_id" class="form-control">
                                                <option value="{{ old('owner_name') }}" selected="" disabled="">নির্বাচন করুন</option>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="road_moholla" class="form-control" id="road_moholla" placeholder="রাস্তা/মহল্লা" value="{{ old('road_moholla') }}">
                                            @error('road_moholla')
                                            <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                               </small>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="owner_current_address" id="owner_current_address" class="form-control owner_current_address" placeholder="বর্তমান ঠিকানা" value="{{ old('owner_current_address') }}">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="owner_permanent_address" id="owner_permanent_address" class="form-control" placeholder="স্থায়ী ঠিকানা" value="{{ old('owner_permanent_address') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="institute_name" class="form-control" placeholder="প্রতিষ্ঠানের নাম" id="institute_name" value="{{ old('institute_name') }}">
                                        ...
                                        <div class="col-sm-6">
                                          ...
                                          <input type="text" name="business_type" id="business_type" class="form-control" value="{{ old('business_type') }}" placeholder="ব্যবসার ধরণ" >
                                          @error('business_type')
                                          <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                               </small>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" name="institute_address" class="form-control" placeholder="ব্যবসা প্রতিষ্ঠানের ঠিকানা" id="institute_address" value="{{ old('institute_address') }}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" name="trade_fee" value="{{ old('trade_fee') }}" class="form-control fee" id="trade_fee" placeholder="ফি">
                                            @error('trade_fee')
                                            <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                               </small>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" name="vat" value="{{ old('vat') }}" class="form-control vat" id="vat" placeholder="ভ্যাট ১৫%" readonly="">
                                            
                                        </div>

                                        <div class="col-sm-6">
                                            <label for="singnboard_tax" class="col-form-label">সাইনবোর্ড কর<span style="color: red">*</span></label>
                                            <input type="number" id="singnboard_tax" name="singnboard_tax" value="{{ old('singnboard_tax') }}" class="form-control singnboard_tax" placeholder="সাইনবোর্ড কর">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" name="business_tax" value="{{ old('business_tax') }}" class="form-control business_tax" id="business_tax" placeholder="ব্যবসা কর">
                                            @error('business_tax')
                                            <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                               </small>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" name="other" value="{{ old('other') }}" class="form-control others" id="other" placeholder="অন্যান্য">
                                            @error('other')
                                            <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                               </small>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" name="trade_total" value="{{ old('trade_total') }}" class="form-control total" id="trade_total" placeholder="Total" readonly="">
                                            @error('trade_total')
                                            <small class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                               </small>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select class="form-control" name="last_license_issue_year" id="last_license_issue_year" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="service_charge_id"  class="form-control" id="service_charge_id" placeholder="Register charge" autocomplete="off" value="{{$service_charge->commercial_fee}}" readonly="">
