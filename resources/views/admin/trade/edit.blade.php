                      ...
                      <div class="form-group row">
                       <label for="storeId" class="col-sm-2 col-form-label">
                        ...
                        <span style="color: red">*</span></label>
                          <div class="col-sm-7">
                            <select class="form-control" name="owner_type" id="">
                     ...
                     <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="fee" class="col-sm-2 col-form-label">ফি</label>
                          <div class="col-sm-7">
                            <input type="text" class="form-control fee" name="fee" value="{{$edit->fee}}">
                          </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control signboard_tax" name="signboard_tax" placeholder="সাইনবোর্ড ট্যাক্স" id="signboard_tax" value="{{$edit->signboard_tax}}">
                          <div class="invalid-feedback">অনুগ্রহ করে এই ঘরটি পুরন কর</div>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="business_tax" class="col-sm-2 col-form-label">ব্যবসা/বাণিজ্য কর  
                          <span style="color: red">*</span></label>
                        <div class="col-sm-7">
                          <input type="number" class="form-control business_tax" name="business_tax" id="business_tax" placeholder="ব্যবসা/বাণিজ্য কর" id="" value="{{$edit->business_tax}}">
                          <div class="invalid-feedback">অনুগ্রহ করে এই ঘরটি পুরন কর.</div>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                          <input type="number" class="form-control others" name="others" id="others" placeholder="অন্যান্য" value="{{$edit->others}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="online_charge" class="col-sm-2 col-form-label">Online Charge</label>
                        <div class="col-sm-7">
                          <input type="number" class="form-control online_charge" name="online_charge" placeholder="Online Charge" id="online_charge" value="{{$edit->online_charge}}">
                        </div>
                      </div>
