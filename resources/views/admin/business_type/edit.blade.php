                  ...
                  <div class="active tab-pane" id="settings"><br><br>
                      <form class="form-horizontal" action="{{route('update.business_type',$edit->id)}}" method="post">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="name" placeholder="প্রাতিষ্ঠানিক নাম" value="{{$edit->name}}">
                        </div>
                      </div> 
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">শুরু মূলধন রেঞ্জ </label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="start_capital_range" placeholder="2000" value="{{$edit->start_capital_range}}">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="last_capital_range" placeholder="3000" value="{{$edit->last_capital_range}}">
                        </div>
                      </div>
