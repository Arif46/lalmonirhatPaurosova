        ...
        <div class="content-body">
            <div class="">
                <marquee scrollamount='3' behavior="" direction="up">
                    <a href="#" class="item">
                        লালমনিরহাট পৌরসভায় স্মার্ট জাতীয় পরিচয়পত্র বিতরন সময়সূচীসূচী
                        <br><small>DD-MM-YYYY</small>
                    </a>
                    <a href="#" class="item">
                        লালমনিরহাট পৌরসভায় চাকুরীর আবেদন পত্র
                        <br><small>DD-MM-YYYY</small>
                    </a>
                    <a href="#" class="item">
                        লালমনিরহাট পৌরসভায় নিয়োগ বিজ্ঞপ্তি
                        <br><small>DD-MM-YYYY</small>
                    </a>
                    <a href="#" class="item">
                        লালমনিরহাট পৌরসভায় স্মার্ট সেনিটেশন সংক্রান্ত নোটিশ
                        <br><small>DD-MM-YYYY</small>
                    </a>
                    <a href="#" class="item">
