                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('webpage.mayorProfile') }}">মেয়রের প্রোফাইল
                                    এবং
                                    সংযোগ</a>
                                <a class="dropdown-item" href="{{ route('webpage.councilor') }}">কাউন্সিলরদের প্রোফাইল
                                    এবং সংযোগ</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ URL::to('/homestead-registration') }}">বসতবাড়ী হোল্ডিং নিবন্ধন</a>
                                <a class="dropdown-item" href="{{ URL::to('/business-registration') }}">ব্যবসা প্রতিষ্ঠান নিবন্ধন</a>
                                <a class="dropdown-item" href="{{ URL::to('/commercial-holding') }}">বানিজ্যিক হোল্ডিং নিবন্ধন</a>
                            </div>
                        </li>
                    </ul>
                </div>
