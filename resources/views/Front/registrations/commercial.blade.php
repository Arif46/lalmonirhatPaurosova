    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="website-form form-group">
                ...
                <form role="form" action="{{route('store.storecommercialholdinfo')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <select name="hold_type" class="form-control" required="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <label for="holding_no" class="col-form-label">হোল্ডিং নং <span style="color: red">*</span></label>
                            <input type="text" name="holding_no" class="form-control" id="road_moholla" placeholder="হোল্ডিং নং">
                        </div>
                        <div class="col-md-3">
